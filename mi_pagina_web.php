...
<body>
    <section id="intro">
        <div class="container-fluid d-flex text-white align-items-center text-center justify-content-center" style="background-image: url(assets/images/ladscape_prueba_darken.JPG); height: 100vh; background-size: cover; background-position: center;">
            <div>
                <h1 style="font-size: 56px;"><b>Programacion IV - Por Hector Luna</b></h1>
                <p class="mt-4">Ut do anim cillum occaecat culpa incididunt voluptate dolore est culpa quis Lorem laborum sint.</p>
